...
//       <h1 className="text-3xl font-bold text-center mb-8 text-slate-800 dark:text-slate-100">Admin Dashboard</h1>
//       <ProjectForm
...
//       />
//       <div className="mt-12">
//         <h2 className="text-2xl font-semibold mb-4 text-slate-700 dark:text-slate-200">Projects List</h2>
//         <ProjectList
//           projects={projects}
